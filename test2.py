...
image = cv2.imread("Resources/shapes3.jpg")
image = cv2.resize(image, (400, 400))

# Get dimensions
h, w, _ = image.shape

# Split into 2x2 regions
regions = {
    "Top Left": image[0:h//2, 0:w//2],
    "Top Right": image[0:h//2, w//2:w],
    "Bottom Left": image[h//2:h, 0:w//2],
    "Bottom Right": image[h//2:h, w//2:w]
}
